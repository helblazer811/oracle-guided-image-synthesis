...
"""
class FacenetOracle(oracle.IOracle):
    ...
    def __init__(self, metadata_dataset=None):
        ...
        if not metadata_dataset is None:
            ...
            self.metadata_dataset = FacenetMetadataDataset()
        self.indexed = False
