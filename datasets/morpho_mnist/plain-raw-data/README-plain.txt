Morpho-MNIST: Plain dataset
===========================

This dataset corresponds to upsampled, binarised, then downsampled MNIST digits,
with no perturbations. It consists of the following files:
